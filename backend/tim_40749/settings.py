"""
Django settings for tim_40749 project.
...
WSGI_APPLICATION = 'tim_40749.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tim_40749 API",
    "DESCRIPTION": "API documentation for tim_40749 App",
    "VERSION": "v1",
}
